...
const ShipperRateModal = ({ cancel, positionStyle , submitBtn}) => {

    return (
        <PageBg style={positionStyle}>
            <Container>
                <GiCancel onClick={cancel} style={cancelBTN} />
                <Title>Rating this shipper</Title>
                <DetailsCont>
                    <ProfileImg src={IMG.profile1} alt="prpofile" />
                    <Name>Alexandre Jun</Name>
                    <StarRow>
...
export default ShipperRateModal;